...
async function main() {
  ...
  const pairingPrompt = `
    Recommend a wine with name and explanantion that pairs well with ${occasion}, considering a preference for ${tastePreference} flavors and taking into account the following dietary restrictions: ${dietaryRestrictions}. Provide a brief explanation for the choice.
  `;
